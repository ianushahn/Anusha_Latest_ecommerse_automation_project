...
public class O7_DropCollectionFromSelectedDatabase {
                ...
                if (dbName == null) {
                    ...
                    if (dbName.length() == 0) {
                        ...
                        if (databaseNameExists) {
                            ...
                            // === Ask for collection name to drop ===
                            System.out.print("Enter collection name to DROP: ");
                            ...
                            if (collName == null) {
                                ...
                                if (collName.length() == 0) {
                                    ...
                                    if (collExists) {
                                        ...
                                        System.out.println("Collection dropped successfully: " + collName);
                                    } else {
